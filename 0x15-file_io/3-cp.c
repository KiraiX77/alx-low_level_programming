 ...
 * @file: refers to the name of the file buffer is storing characters for
 *
 * Return: returns a pointer to the new-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
 ...
 * @fd: refers to the file descriptor that wil be closed.
 */
void close_file(int fd)
{
	int k;
 ...
 * If file_to cannot be wriiten or created  to - exit code 99.
